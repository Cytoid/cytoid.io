<template>
  <footer class="footer footer-center my-10 text-base-content rounded">
    <div>
      <div class="footer-item-box grid grid-flow-col">
        ...
        <NuxtLink class="clickable select-none" to="https://github.com/Cytoid/">GitHub</NuxtLink>
        <NuxtLink class="clickable select-none" to="/credits">{{ $t('general.credits') }}</NuxtLink>
        <div ref="langSelect" :class="{
          'dropdown dropdown-top dropdown-hover dropdown-end': true,
