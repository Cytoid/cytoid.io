  ...
  >
    ...
    >
      <div class="card w-full overflow-hidden bg-base-100 shadow-xl">
        <div
          class="card card-body flex flex-col bg-secondary/25"
        >
          <!-- Background -->
          <div
            v-if="userOnlineCover || file" class="pointer-events-none absolute left-0 top-0 size-full bg-cover bg-center opacity-25 blur-3xl"
            :style="{
